                    ...
                    <div class="row mt-4 mb-2">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="number" class="form-control cus-ra-right" name="duration" value="<?php if(isset($service[0]['duration'])){echo html_escape($service[0]['duration']);} ?>" required>
                              
                              <div>
                                <select class="form-control cus-ra-left" name="duration_type">
                                    <option value="minute" <?php if($service[0]['duration_type'] == 'minute'){echo "selected";} ?> <?php if (isset($page_title) && $page_title != "Edit"){echo "selected";} ?>><?php echo trans('minute') ?></option>
                                    <option value="hour" <?php if($service[0]['duration_type'] == 'hour'){echo "selected";} ?>><?php echo trans('hour') ?></option>
